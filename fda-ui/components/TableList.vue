        ...
        <v-expansion-panel-content class="mb-2">
          <v-row dense>
            <v-col>
              <v-list dense>
                ...
                <v-list-item v-if="tableDetails.description">
                  <v-list-item-content>
                    <v-list-item-title>
                      Description
                    </v-list-item-title>
          ...
          <v-row v-if="isPublicOrOwner" dense>
            <v-col>
              ...
              <v-btn v-if="isOwner" class="ml-2" :to="`/container/${$route.params.container_id}/database/${$route.params.database_id}/table/${item.id}/import`">
                Import csv
              </v-btn>
            </v-col>
