...
(
    ...
    origin_owner_site     VARCHAR(255),
    origin_owner_issuer   VARCHAR(255),
    origin_owner_subject  VARCHAR(255),
    origin_owner_username VARCHAR(255),
    replication_access_status VARCHAR(32),
    replication_local_username VARCHAR(255),
    created               TIMESTAMP    NOT NULL DEFAULT NOW(),
    last_modified         TIMESTAMP,
    PRIMARY KEY (`id`),
