...
@Table(name = "mdb_identifier_titles", uniqueConstraints = {
        @UniqueConstraint(columnNames = {"iid", "language"})
})
public class IdentifierTitle implements Serializable {
    ...
    @Column(columnDefinition = "ENUM('AlternativeTitle', 'Subtitle', 'TranslatedTitle', 'Other')")
