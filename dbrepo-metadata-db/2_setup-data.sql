...
VALUES ('6cfb3b8e-1792-4e46-871a-f3d103527203', 'mariadb-galera:11.3.2', 'mariadb_galera_11_3_2',
        ...
        'readonly'),
       ('6cfb3b8e-1792-4e46-871a-f3d103527204', 'postgresql:17.9', 'postgresql_17.9',
        'd79cb089-363c-488b-9717-649e44d8fcc6', 'data-db2', 5432, 'localhost', 5432, 'dbrepo', 'dbrepo', 'dbrepo',
        'dbrepo');
