...
public interface TableMapper {
     ...
     */
    default PreparedStatement tableToCreateTableRawQuery(Connection connection, TableCreateDto data)
        ...
        for (ColumnCreateDto column : data.getColumns()) {
            query.append(idx[0]++ > 0 ? ", " : "")
                    ...
                    /* default expressions */
                    .append(!primaryColumnExists && column.getName().equals("id") ? " AUTO_INCREMENT" : "");
        }
        ...
        try {
            log.trace("mapped create table statement: {}", query);
