...
public class TimeSecretEndpoint {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "302",
                    description = "Verify succeeded",
                    headers = {@Header(name="Location", description = "Redirect to this address", required = true)},
                    content = {@Content}),
            @ApiResponse(responseCode = "405",
                    description = "Verify not allowed while logged-in",
                    content = {@Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = ApiErrorDto.class))}),
            @ApiResponse(responseCode = "417",
                    description = "Verify token is invalid",
                    content = {@Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = ApiErrorDto.class))}),
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "202",
                    description = "Time secret resend succeeded",
                    content = {@Content}),
            @ApiResponse(responseCode = "404",
                    ...
                    content = {@Content(
                            ...
                            schema = @Schema(implementation = ApiErrorDto.class))}),
            @ApiResponse(responseCode = "405",
                    description = "Time secret resend not allowed while logged-in",
                    content = {@Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = ApiErrorDto.class))}),
            @ApiResponse(responseCode = "424",
                    description = "User e-mail is already verified",
                    content = {@Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = ApiErrorDto.class))}),
            @ApiResponse(responseCode = "428",
                    description = "Time secret send failed",
                    content = {@Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = ApiErrorDto.class))}),
    })
