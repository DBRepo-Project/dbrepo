...
public class UserEndpoint {
    ...
    @PutMapping("/password")
    @Operation(summary = "Modifies user password")
    public ResponseEntity<?> modify(@NotNull @Valid @RequestBody UserModifyPasswordDto data)
            throws ProcessCompletionException {
        queueService.modifyPassword(data);
    ...
    public ResponseEntity<?> grant(@NotNull @Valid @RequestBody GrantComponentDto data)
            throws ProcessCompletionException {
