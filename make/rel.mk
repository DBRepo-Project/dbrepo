...
tag-images: ## Tag the docker images.
	...
	docker tag dbrepo-replication-service:latest "${REPOSITORY_URL}/replication-service:${APP_VERSION}${BUILD_VERSION}"
...
release-images: tag-images ## Release the docker images.
	...
	docker push "${REPOSITORY_URL}/replication-service:${APP_VERSION}${BUILD_VERSION}"
