...
.PHONY: build-images
build-images: build-java-lib build-python-lib build-duckdb-lib ## Build Docker images.
...
.PHONY: build-duckdb-lib
build-duckdb-lib: ## Build the DuckDB Extensions.
	bash ./.scripts/build-duckdb-lib.sh
