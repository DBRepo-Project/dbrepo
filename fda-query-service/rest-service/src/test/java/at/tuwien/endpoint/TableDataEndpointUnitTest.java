...
public class TableDataEndpointUnitTest extends BaseUnitTest {
    ...
    public void insert_succeeds() throws TableNotFoundException, TableMalformedException, DatabaseNotFoundException,
            ImageNotSupportedException, ContainerNotFoundException, NotAllowedException, DatabaseConnectionException, QueryMalformedException, UserNotFoundException {
    ...
    public void insert_locationNull_succeeds() throws TableNotFoundException, TableMalformedException,
            ...
            NotAllowedException, DatabaseConnectionException, UserNotFoundException {
    ...
    @Test
    @WithMockUser(username = USER_1_USERNAME)
    public void insert_locationAndDataNull_fails() throws DatabaseNotFoundException, TableNotFoundException, TableMalformedException, DatabaseConnectionException, ImageNotSupportedException, ContainerNotFoundException, UserNotFoundException {
        final Principal principal = SecurityContextHolder.getContext().getAuthentication();
    ...
    public void findAll_noPagination_succeeds() throws TableNotFoundException, DatabaseConnectionException,
            ...
            ContainerNotFoundException, QueryStoreException, NotAllowedException, QueryMalformedException, SortException, UserNotFoundException {
    ...
    public void getAllTotal_succeeds() throws TableNotFoundException, DatabaseConnectionException,
            ...
            QueryMalformedException, SortException, UserNotFoundException {
