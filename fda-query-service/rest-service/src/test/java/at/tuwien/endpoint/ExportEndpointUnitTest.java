...
public class ExportEndpointUnitTest extends BaseUnitTest {
    ...
    public void export_timestampNull_succeeds() throws TableNotFoundException, DatabaseConnectionException,
            ...
            PaginationException, ContainerNotFoundException, NotAllowedException, QueryMalformedException, UserNotFoundException {
        ...
        doReturn(
                ...
                .findAll(CONTAINER_1_ID, DATABASE_1_ID, TABLE_1_ID, null, principal);
    ...
    public void export_succeeds() throws TableNotFoundException, DatabaseConnectionException, TableMalformedException,
            ...
            ContainerNotFoundException, NotAllowedException, QueryMalformedException, UserNotFoundException {
        ...
        doReturn(
                ...
                .findAll(CONTAINER_1_ID, DATABASE_1_ID, TABLE_1_ID, request, principal);
