...
public class DatabaseBriefDto {
    ...
    @Schema(description = "Map of replica URL to replica database ID", nullable = true)
    private Map<String, UUID> replicaUrls;

    @JsonProperty("creation_location")
    @Schema(description = "The site where the database was initially created", nullable = true)
