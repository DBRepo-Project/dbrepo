...
[[runners]]
  ...
  [runners.kubernetes]
    ...
    [[runners.kubernetes.services]]
      name = "docker:24-dind"
      command = [ "--insecure-registry=docker-io-mirror:80", "--insecure-registry=gcr-io-mirror:80", "--insecure-registry=ghcr-io-mirror:80", "--insecure-registry=k8s-io-mirror:80" ]
      alias = "docker"
