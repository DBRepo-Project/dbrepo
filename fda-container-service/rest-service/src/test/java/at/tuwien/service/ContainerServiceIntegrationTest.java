...
public class ContainerServiceIntegrationTest extends BaseUnitTest {
    ...
    @Test
    public void create_succeeds() throws UserNotFoundException, DockerClientException, ContainerAlreadyExistsException,
        ...
        /* test */
        final Container response = containerService.create(request, principal);
