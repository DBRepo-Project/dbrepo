...
public class UnitServiceIntegrationTest extends BaseUnitTest {
    ...
    public void findAll_succeeds() {
        ...
        /* test */
        final List<TableColumnUnit> units = unitService.findAll();
        assertEquals(2, units.size());
        final TableColumnUnit unit0 = units.get(0);
        assertEquals(UNIT_1_ID, unit0.getId());
        ...
        final TableColumnUnit unit1 = units.get(1);
        assertEquals(UNIT_2_ID, unit1.getId());
        assertEquals(UNIT_2_NAME, unit1.getName());
        assertEquals(UNIT_2_URI, unit1.getUri());
        assertEquals(UNIT_2_DESCRIPTION, unit1.getDescription());
    }
}
