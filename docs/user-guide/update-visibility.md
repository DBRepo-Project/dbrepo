...
* **Hidden**
    ...
    No [database dashboard](/dbrepo/1.13/database-dashboard) is visible to anyone.

### UI

<video autoplay loop>
  <source src="/dbrepo/1.13/videos/update-visibility.webm" type="video/webm" />
  <source src="/dbrepo/1.13/videos/update-visibility.mp4" type="video/mp4" />
</video>
