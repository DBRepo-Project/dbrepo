...
<video autoplay loop>
  <source src="/dbrepo/1.13/videos/database-dashboard.webm" type="video/webm" />
  <source src="/dbrepo/1.13/videos/database-dashboard.mp4" type="video/mp4" />
</video>

!!! abstract "Note"

    Database dashboards are only available for non-hidden databases, see [Update Visibility](/dbrepo/1.13/update-visibility).
...
<video autoplay loop>
  <source src="/dbrepo/1.13/videos/disable-dashboard.webm" type="video/webm" />
  <source src="/dbrepo/1.13/videos/disable-dashboard.mp4" type="video/mp4" />
</video>
