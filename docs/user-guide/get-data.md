...
<video autoplay loop>
  <source src="/dbrepo/1.13/videos/fetch-data.webm" type="video/webm" />
  <source src="/dbrepo/1.13/videos/fetch-data.mp4" type="video/mp4" />
</video>

Export the complete data of the data source by clicking the "Download" button.

<video autoplay loop>
  <source src="/dbrepo/1.13/videos/export-data.webm" type="video/webm" />
  <source src="/dbrepo/1.13/videos/export-data.mp4" type="video/mp4" />
</video>
