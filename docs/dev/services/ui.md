...
!!! debug "Debug Information"
    ...
    Image: [`ghcr.io/dbrepo-project/dbrepo/ui:1.11.0`](https://github.com/orgs/DBRepo-Project/packages)
...
<figure markdown>
![Architecture of the UI microservice](/dbrepo/1.13/images/screenshots/ui-config-step-1.png)
</figure>
...
=== "Kubernetes"
    ...
    Then you need to mount the configmap into the [Gateway Service](/dbrepo/1.13/gateway-service) under `/etc/nginx/assets/assets`.
...
<figure markdown>
![Architecture of the UI microservice](/dbrepo/1.13/images/architecture-ui.svg)
</figure>
