...
registered in the Metadata Database to be visible in the [User Interface](/dbrepo/1.13/dev/services/ui) and usable from e.g. the Python
Library.
...
a [full backup](/dbrepo/1.13/maintainer-guide/backup-data/) 
and [restore](/dbrepo/1.13/maintainer-guide/restore-data/).
