...
!!! debug "Debug Information"
    ...
    Image: [`ghcr.io/dbrepo-project/dbrepo/metadata-service:1.11.0`](https://github.com/orgs/DBRepo-Project/packages)
...
The metadata service manages metadata of identities, the [Broker Service](/dbrepo/1.13/broker-service) (i.e. obtaining queue
...
services:
  dbrepo-metadata-service:
    image: ghcr.io/dbrepo-project/dbrepo/metadata-service:1.11.0
    environment:
...
the [Metadata Database](/dbrepo/1.13/dev/services/metadata-db) from registered ontologies
