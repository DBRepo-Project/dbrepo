...
the [Python Library](/dbrepo/1.13/open-api) page for more details.
...
=== "UI"
    ...
    the system creates a user account in Figure 1 with the [default roles](/dbrepo/1.13/system-services-authentication/#roles)
    that your administrator has assigned.

    <figure markdown>
    ![Create user account](/dbrepo/1.13/images/screenshots/create-account-step-1.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Create user account](/dbrepo/1.13/images/screenshots/create-account-step-2.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Change user account password](/dbrepo/1.13/images/screenshots/create-account-step-3.png){ .img-border }
    </figure>
...
=== "UI"
    ...
    <figure markdown>
    ![Open the create database dialog](/dbrepo/1.13/images/screenshots/create-database-step-1.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Create database form](/dbrepo/1.13/images/screenshots/create-database-step-2.png){ .img-border }
    </figure>

    After a few seconds, you can see the created database in the "Recent Databases" list, as seen in Figure 6.

    <figure markdown>
    ![View the created database](/dbrepo/1.13/images/screenshots/create-database-step-3.png){ .img-border }
    </figure>
...
=== "UI"
    ...
    <figure markdown>
    ![Open the import CSV form](/dbrepo/1.13/images/screenshots/import-dataset-step-1.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Basic table information](/dbrepo/1.13/images/screenshots/import-dataset-step-2.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Dataset metadata necessary for import](/dbrepo/1.13/images/screenshots/import-dataset-step-3.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Dataset import file](/dbrepo/1.13/images/screenshots/import-dataset-step-4.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Confirm the table schema and provide missing information](/dbrepo/1.13/images/screenshots/import-dataset-step-5.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Confirm the table schema and provide missing information](/dbrepo/1.13/images/screenshots/import-dataset-step-6.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Table data](/dbrepo/1.13/images/screenshots/import-dataset-step-7.png){ .img-border }
    </figure>
...
=== "UI"
    ...
    [Data Database](/dbrepo/1.13/system-databases-data/) :material-numeric-2-circle-outline:.
    ...
    <figure markdown>
    ![Setup New Connection in MySQL Workbench](/dbrepo/1.13/images/screenshots/import-database-dump-step-1.png)
    </figure>
    ...
    <figure markdown>
    ![Server status of the Data Database in MySQL Workbench](/dbrepo/1.13/images/screenshots/import-database-dump-step-2.png)
    </figure>
    ...
    <figure markdown>
    ![Data Import/Restore in MySQL Workbench](/dbrepo/1.13/images/screenshots/import-database-dump-step-3.png)
    </figure>
...
=== "Terminal"
    ...
    The [Metadata Service](/dbrepo/1.13/system-services-metadata) periodically (by default configuration every 60 seconds) checks
    and adds missing tables and views to the [Metadata Database](/dbrepo/1.13/system-databases-metadata), the database dump
    ...
    !!! example "Specifying a custom date format"
        ...
        administrator needs to add it manually in the [Metadata Database](/dbrepo/1.13/system-databases-metadata).
...
=== "JDBC API"
    ...
    <figure markdown>
    ![JDBC connection information](/dbrepo/1.13/images/screenshots/database-jdbc.png){ .img-border }
    </figure>
...
=== "Python"
    ...
    <figure markdown>
    ![AMQP connection information](/dbrepo/1.13/images/screenshots/table-amqp.png){ .img-border }
    </figure>
...
=== "UI"
    ...
    <figure markdown>
    ![Open the create subset form](/dbrepo/1.13/images/screenshots/export-subset-step-1.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Subset query building](/dbrepo/1.13/images/screenshots/export-subset-step-2.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Subset result set](/dbrepo/1.13/images/screenshots/export-subset-step-3.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Subset information](/dbrepo/1.13/images/screenshots/export-subset-step-4.png){ .img-border }
    </figure>
...
=== "JDBC"
    ...
    can persist the subset in the [Data Database](/dbrepo/1.13/system-databases-data) through JDBC by setting the `persisted`
...
=== "UI"
    ...
    <figure markdown>
    ![Open the get persisent identifier form](/dbrepo/1.13/images/screenshots/assign-database-pid-step-1.png){ .img-border }
    </figure>

    First, provide information on the dataset creator(s). Since the [Metadata Service](/dbrepo/1.13/system-services-metadata) 
    ...
    <figure markdown>
    ![Identifier creator fields](/dbrepo/1.13/images/screenshots/assign-database-pid-step-2.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![JDBC connection information](/dbrepo/1.13/images/screenshots/assign-database-pid-step-3.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Identifier description fields and publishing information](/dbrepo/1.13/images/screenshots/assign-database-pid-step-4.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Related identifiers, license and language of the identifier](/dbrepo/1.13/images/screenshots/assign-database-pid-step-5.png){ .img-border }
    </figure>

    Optionally add funding information, again the [Metadata Service](/dbrepo/1.13/system-services-metadata) 
    automatically resolves external PIDs, the easiest way is to provide the correct mandatory data is by filling the
    ...
    <figure markdown>
    ![Identifier funder information](/dbrepo/1.13/images/screenshots/assign-database-pid-step-6.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Identifier summary page](/dbrepo/1.13/images/screenshots/assign-database-pid-step-7.png){ .img-border }
    </figure>
...
=== "JDBC"
    ...
    !!! warning
        ...
        Creating a PID directly in the [Metadata Database](/dbrepo/1.13/system-databases-metadata) is not recommended! It bypasses
    ...
    Create a local PID directly in the [Metadata Database](/dbrepo/1.13/system-databases-metadata) by filling the tables in this
...
=== "UI"
    ...
    <figure markdown>
    ![Database settings for visibility and access](/dbrepo/1.13/images/screenshots/private-database-access-step-1.png){ .img-border }
    </figure>
    ...
    <figure markdown>
    ![Database acccess dialog](/dbrepo/1.13/images/screenshots/private-database-access-step-2.png){ .img-border }
    </figure>
...
=== "JDBC"
    ...
    the [Metadata Database](/dbrepo/1.13/system-databases-metadata), change the visibility directly by executing the SQL-query
    in the `fda` schema:
