...
[Identity Service](/dbrepo/1.13/dev/services/identity-service) to access the Broker Service as user with 
...
<figure markdown>
   ![Data ingest](/dbrepo/1.13/images/queue-quorum.png)
</figure>

The consumer takes care of writing it to the correct table in 
the [Data Service](/dbrepo/1.13/dev/services/data-service).

<figure markdown>
   ![Data ingest](/dbrepo/1.13/images/exchange-binding.png)
</figure>
...
1. Once you change the admin password of the [Identity Service](/dbrepo/1.13/dev/services/identity-service), 
