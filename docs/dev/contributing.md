...
<figure markdown>
![Branching strategy from the master-dev-feature branches and release branches](/dbrepo/1.13/images/branching-strategy.svg)
</figure>
...
<figure markdown>
![Gitlab runner configuration in the cluster](/dbrepo/1.13/images/gitlab-runner.png)
</figure>
