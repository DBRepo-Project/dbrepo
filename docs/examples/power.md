...
<figure markdown>
![](/dbrepo/1.13/images/screenshots/power.png)
...
We connected our [Broker Service](/dbrepo/1.13/api/broker-service) with the MQTT broker of the Pilotfabrik using a self-written
...
<img src="/dbrepo/1.13/images/logos/ift.jpeg" width=100 />
