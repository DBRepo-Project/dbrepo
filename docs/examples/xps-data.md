...
<figure markdown>
![Jupyter Notebook](/dbrepo/1.13/images/screenshots/xps-notebook.png){ .img-border }
...
<figure markdown>
![Three charts displaying surface analysis data of C, O and Su](/dbrepo/1.13/images/screenshots/xps-chart.png){ .img-border }
...
<img src="/dbrepo/1.13/images/logos/iap.png" width=100 />