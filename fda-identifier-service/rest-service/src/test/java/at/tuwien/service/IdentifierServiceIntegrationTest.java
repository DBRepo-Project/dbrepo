...
public class IdentifierServiceIntegrationTest extends BaseUnitTest {
    ...
    @Test
    public void update_succeeds() throws IdentifierPublishingNotAllowedException, IdentifierNotFoundException {

        /* test */
        final Identifier response = identifierService.update(IDENTIFIER_1_ID, IDENTIFIER_1_MODIFY_DTO);
        assertEquals(IDENTIFIER_1_ID, response.getId());
        assertEquals(IDENTIFIER_1_TITLE_MODIFY, response.getTitle());
        assertEquals(IDENTIFIER_1_DESCRIPTION_MODIFY, response.getDescription());
        assertEquals(IDENTIFIER_1_DOI, response.getDoi());
        assertEquals(IDENTIFIER_1_PUBLISHER, response.getPublisher());
        assertEquals(IDENTIFIER_1_CONTAINER_ID, response.getContainerId());
