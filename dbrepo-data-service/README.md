...
Or run only tests 
in [`DatabaseServiceIntegrationTest.java`](https://github.com/DBRepo-Project/dbrepo/blob/master/dbrepo-data-service/rest-service/src/test/java/at/tuwien/service/DatabaseServiceIntegrationTest.java):
