...
public class TableServiceIntegrationTest extends BaseUnitTest {
    ...
    public void findAll_succeeds() throws QueryMalformedException {
        ...
        assertEquals("hs_weather_aus", table0.getName());
        assertEquals("hs_weather_aus", table0.getInternalName());
        final TableBriefDto table1 = tables.get(1);
        assertEquals("hs_weather_aus", table1.getName());
        assertEquals("hs_weather_aus", table1.getInternalName());
    }
    ...
    public void save_succeeds() {
        final TableDto request = TableDto.builder()
                ...
                .creator(USER_1_DTO)
                .owner(USER_1_DTO)
                .columns(List.of(ColumnDto.builder()
                                .name("id")
                                .internalName("id")
        ...
        /* test */
        final Table response = tableService.save(request);
    }
}
