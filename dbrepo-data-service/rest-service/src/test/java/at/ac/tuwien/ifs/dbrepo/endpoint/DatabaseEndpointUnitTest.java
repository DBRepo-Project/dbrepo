...
public class DatabaseEndpointUnitTest extends BaseTest {
    ...
    public void analyseDatatypes_succeeds() throws DatabaseUnavailableException, StorageNotFoundException,
            ...
            ContainerNotFoundException, DatabaseNotFoundException, ColumnNotFoundException {
        ...
        /* test */
        final ResponseEntity<SchemaAnalysisResultDto> response = databaseEndpoint.analyseDatatypes(CONTAINER_1_ID, "s3key");
